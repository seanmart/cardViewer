export default {
  ...
  items: [
    {
      front: { image: "/logos/agilon.jpg" },
      back: {
        images: ["/images/agilon.jpg"],
        title: "agilon health",
        text:
          "A healthcare services and technology company specializing in a value-based healthcare delivery system serving over 750,000 patients though a network of over 9,000 physicians who are compensated based on patient health outcomes, not services rendered.  A partnership that has transformed and revolutionized the healthcare delivery system for patients and physicians."
      }
    },
    {
      front: { image: "/logos/americangreetings.jpg" },
      back: {
    ...
    {
      front: { image: "/logos/belron.jpg" },
      back: {
        images: ["/images/belron.jpg"],
        title: "Belron",
        text:
          "A world-wide leader in the vehicle glass repair and replacement market across over 30 countries on 6 continents and over 30,000 employees with 10 major brands, including US-based Safelite AutoGlass."
      }
    },
    {
      front: { image: "/logos/but.jpg" },
      back: {
        images: ["/images/but.jpg"],
        title: "BUT",
        text:
          "Largest furniture retailer network in France who provides furniture, appliances, consumer electronics and other home goods to consumers worldwide."
      }
    },
    {
    ...
    {
      front: { image: "/logos/coremain.jpg" },
      back: {
        title: "Core & Main",
        text:
          "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum."
    ...
    {
      front: { image: "/logos/covetrus.jpg" },
      back: {
        title: "Covetrus",
        text:
          "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum."
    ...
    {
      front: { image: "/logos/healogics.jpg" },
      back: {
        title: "Healogics",
        text:
          "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum."
    ...
    {
      front: { image: "/logos/trugreen.jpg" },
      back: {
        title: "Trugreen",
        text:
          "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum."
